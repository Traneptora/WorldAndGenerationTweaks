    ...
    public int[] getInts(int par1, int par2, int par3, int par4)
    {
        ...
        for (int i2 = 0; i2 < par4; ++i2)
        {
            for (int j2 = 0; j2 < par3; ++j2)
            {
                ...
                if (k3 == 0 && k2 == 0 && l2 == 0 && i3 == 0 && j3 == 0 && this.nextInt(WorldAndGenerationTweaks.instance.getConfiguration().getPropertyBoolean(ConfigOption.MORE_MUSHROOM_BIOMES) ? 1 : 100) == 0)
                {
