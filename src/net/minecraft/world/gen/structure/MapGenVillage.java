...
public class MapGenVillage extends MapGenStructure
{
    ...
    {
    	Random random = null;
		for (int i = 0; i < (WorldAndGenerationTweaks.instance.getConfiguration().getPropertyBoolean(ConfigOption.MORE_VILLAGES) ? 4 : 1); i++) {
	        int k = par1;
	        int l = par2;
	        ...
	        if (random == null) {
				random = this.worldObj.setRandomSeed(i1, j1, 10387312);
			}
