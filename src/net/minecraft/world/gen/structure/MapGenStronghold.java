...
import thebombzen.mods.worldandgenerationtweaks.ConfigOption;
...
public class MapGenStronghold extends MapGenStructure
{
    ...
    public MapGenStronghold()
    {
        ...
        this.structureCoords = new ChunkCoordIntPair[WorldAndGenerationTweaks.instance.getConfiguration().getPropertyBoolean(ConfigOption.MORE_STRONGHOLDS) ? 6 : 3];
        this.field_82671_h = WorldAndGenerationTweaks.instance.getConfiguration().getPropertyBoolean(ConfigOption.MORE_STRONGHOLDS) ? 16.0D : 32.0D;
